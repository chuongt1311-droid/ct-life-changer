...
| 2 | **Visual design** | `impeccable` design pass: direction, design tokens, comps for Today, Check-in, Day changed, Re-entry ramp, Mentor. Recorded in `DESIGN.md`. | — (can run alongside 1) | ~30 min of taste decisions |
